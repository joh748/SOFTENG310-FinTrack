  ...
  return (
    <>
      ...
      <div className="scrollableContent">
        ...
        <h2 className="genericH2">FinTrack is a free, open source financial tracker designed and developed for SOFTENG 310, software evolution and maintenance, at The University of Auckland, New Zealand. The project is a joint effort between <a style={{color: "var(--color3)"}} href="https://github.com/Taks0708">Meow Meow Silly Cats</a> and <a style={{color: "var(--color3)"}} href="https://https://github.com/SE310-Team-1.com/Taks0708">Group 1</a>(We didn't need a name, our designation in first place speaks volumes).</h2>
        ...
        <h2 className="genericH2"><b>DISCLAIMER:</b> While Gemini is particuarly good at summarising finance concepts, advice generated by this website may occasionally be inacurate or misleading due to the nature of machine learning. Please validate advice with a reliable source before acting on it.</h2>
        <LuckyAdviser/> 
      </div>
